        ...
        <aside id="left-nav" className="w-56 bg-gray-50 h-screen sticky top-20 hidden lg:block">
          <nav className="p-6">
            <ul className="space-y-2">
              <li><span className="nav-link block py-2 px-3 rounded-md text-sm font-medium text-gray-600 hover:bg-gray-200 transition-colors cursor-pointer bg-gray-200 text-gray-900" data-section="overview">Overview</span></li>
          ...
          <section id="overview" className="px-6 py-16">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                ...
                <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded-full text-sm font-medium">IoT Design</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded-full text-sm font-medium">Machine Learning</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded-full text-sm font-medium">Hardware Integration</span>
              </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <svg className="text-gray-500 text-lg mr-3 w-5 h-5" fill="currentColor" viewBox="0 0 512 512">
                    ...
                    <div className="flex items-center">
                      <svg className="text-gray-500 text-lg mr-3 w-5 h-5" fill="currentColor" viewBox="0 0 448 512">
                    ...
                    <div className="flex items-center">
                      <svg className="text-gray-500 text-lg mr-3 w-5 h-5" fill="currentColor" viewBox="0 0 576 512">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-gray-300">
                  <div className="flex items-start">
                    <svg className="text-gray-400 text-xl mr-4 mt-1 w-6 h-6" fill="currentColor" viewBox="0 0 384 512">
                      <path d="M272 384c9.6-31.9 29.5-59.1 49.2-86.2l0 0c5.2-7.1 10.4-14.2 15.4-21.4c19.8-28.5 31.4-63 31.4-100.3C368 78.8 289.2 0 192 0S16 78.8 16 176c0 37.3 11.6 71.9 31.4 100.3c5 7.2 10.2 14.3 15.4 21.4l0 0c19.8 27.1 39.7 54.4 49.2 86.2H272zM192 512c44.2 0 80-35.8 80-80V416H112v16c0 44.2 35.8 80 80 80zM112 176c0 8.8-7.2 16-16 16s-16-7.2-16-16c0-61.9 50.1-112 112-112c8.8 0 16 7.2 16 16s-7.2 16-16 16c-44.2 0-80 35.8-80 80z"/>
                    </svg>
                    <div>
                ...
                <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-gray-300">
                  <div className="flex items-start">
                    <svg className="text-gray-400 text-xl mr-4 mt-1 w-6 h-6" fill="currentColor" viewBox="0 0 512 512">
                  ...
                  <div className="w-3/5 space-y-4">
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center mb-2">
                        <svg className="text-gray-500 mr-2 w-5 h-5" fill="currentColor" viewBox="0 0 512 512">
                          <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z"/>
                        </svg>
                        <span className="font-semibold text-gray-700">Problem</span>
                      </div>
                      <p className="text-gray-600 text-sm">External feedback and testing showed IMU data lacked context, and the model couldn&apos;t generalize beyond a few individuals.</p>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center mb-2">
                          ...
                          <span className="font-semibold text-gray-700">Improvements</span>
                        </div>
                        <ul className="text-gray-600 text-sm space-y-1">
            ...
            <div className="max-w-4xl">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 text-center">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-2">91–98%</div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900 mb-2">Proof</div>
          ...
          <section id="reflection" className="px-6 py-16 border-t border-gray-200">
            <div className="max-w-4xl">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  <div className="flex items-center mb-4">
                    <svg className="text-gray-500 text-2xl mr-3 w-6 h-6" fill="currentColor" viewBox="0 0 512 512">
              ...
              <div className="bg-gray-50 rounded-xl p-8 border-l-4 border-gray-300">
