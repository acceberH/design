      ...
      <div className="flex max-w-7xl mx-auto">
        ...
        <main className="flex-1 lg:ml-8">
          ...
          <section id="hero" className="px-6 py-16">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                ...
                <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded-full text-sm font-medium shadow-sm">Product Design</span>
              </div>
          ...
          <section id="context" className="px-6 py-16 border-t border-gray-200">
            <div className="max-w-4xl">
              <span className="text-xs font-bold tracking-widest uppercase text-gray-400 mb-3 block">Research</span>
                ...
                <div className="my-12 space-y-6">
                  ...
                  <div className="grid grid-cols-[78px_1fr] md:grid-cols-[110px_1fr] items-center gap-3 md:gap-5">
                    ...
                    <p className="text-lg text-gray-800 leading-relaxed font-medium">
                      <span className="text-gray-700">Design Opportunity:</span> How might we help people extract insights from complex research materials in minutes rather than hours?
                    </p>
                  </div>
                </div>
          ...
          <section id="approach" className="px-6 py-16 border-t border-gray-200">
            <div className="max-w-4xl">
              <span className="text-xs font-bold tracking-widest uppercase text-gray-400 mb-3 block">Design Process</span>
              <h2 className="text-4xl font-extrabold tracking-tight text-gray-900 mb-8">Approach</h2>
              
              {/* Phase 1 - Competitive Analysis */}
              <div className="mb-16">
                <div className="mb-6">
                  <span className="text-xs font-bold tracking-widest uppercase text-gray-400 bg-gray-100 px-3 py-1 rounded-full mb-3 inline-block">Step 01</span>
              ...
              <div className="mb-8">
                <div className="mb-6">
                  <span className="text-xs font-bold tracking-widest uppercase text-gray-400 bg-gray-100 px-3 py-1 rounded-full mb-3 inline-block">Step 02</span>
          ...
          <section id="reflect" className="px-6 py-16 border-t border-gray-200">
            <div className="max-w-4xl">
              <span className="text-xs font-bold tracking-widest uppercase text-gray-400 mb-3 block">Learnings</span>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="text-center">
            <div className="flex justify-center space-x-6 mb-4">
              <a href="https://www.linkedin.com/in/rebecca-huang-a60388249/" className="text-gray-600 hover:text-gray-900 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" />
                </svg>
              </a>
              <a href="mailto:rebecca.huang@example.com" className="text-gray-600 hover:text-gray-900 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
