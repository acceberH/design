  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="py-20 px-6 text-center border-t border-gray-100">
        ...
        <a href={scopedHref(pathname, "/work/barbuddy")} className="group inline-flex items-center gap-3 text-[28px] font-bold text-gray-900 hover:text-gray-400 transition-colors duration-200">
          BarBuddy
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href={scopedHref(pathname, "/work/barbuddy")} className="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
              Next Project
