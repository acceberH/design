                ...
                <div className="pt-2 space-y-5">
                  ...
                  <div className="grid grid-cols-[78px_1fr] md:grid-cols-[110px_1fr] items-center gap-3 md:gap-5">
                    ...
                    <p className="text-lg text-gray-800 leading-relaxed font-medium">
                      <span className="text-indigo-700">Design Opportunity:</span> How might we help businesses manage content across multiple social platforms without constantly switching between different apps?
                    </p>
                  </div>
                </div>
              </div>
