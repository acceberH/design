...
// Stacking version card — sticky with increasing z-index, later = higher
function VersionCard({
  children, index, total, label,
}: {
  children: React.ReactNode; index: number; total: number; label: string;
}) {
  const isLast = index === total - 1;
  // Each card sticks at 80px + (n-1-index)*18 so Final is highest, V1 is lowest
  // When all stuck, you see Final on top, then V2/V3 peeking below
  const topOffset = 80 + (total - 1 - index) * 18;
  return (
    <div
      className="sticky bg-white rounded-2xl overflow-hidden"
      style={{
        top: topOffset,
        zIndex: 10 + index,
    ...
    >
      ...
      <div className="flex items-center gap-2 px-5 py-2.5 border-b border-gray-100 bg-gray-50/60">
        <span className={`text-[11px] font-semibold tracking-wide px-2.5 py-0.5 rounded-full ${
          isLast ? "bg-gray-900 text-white" : "bg-white border border-gray-200 text-gray-500"
        }`}>{label}</span>
      </div>
            ...
            <div className="max-w-4xl">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[180px_1fr] gap-6 items-start">
                  <ImageReveal>
                    <Image src="/openpromo_confused.png" alt="Small business owner interview illustration" width={180} height={180} className="w-36 h-auto" />
                  </ImageReveal>
                  <FadeIn delay={0.1}>
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-2" id="solution-one">
                ...
                <div style={{ isolation: "isolate", position: "relative" }}>
                  {/* V1 */}
                  <VersionCard index={0} total={3} label="V1">
                    <div className="grid grid-cols-1 md:grid-cols-[6fr_4fr] gap-5 items-start">
                      ...
                      <div>
                        <p className="text-base text-gray-700 leading-relaxed">Instant Ad is a standalone workspace accessible from the left menu bar. If users want to create ads, they go there first, then switch to Create Post to publish.</p>
                        <h5 className="text-xs font-bold uppercase tracking-[0.1em] text-[#fca5a5] mt-4 mb-2">Problem</h5>
                        <p className="text-base text-gray-700 leading-relaxed">The workflow is fragmented. Users have to move back and forth between two separate areas to complete one task.</p>
                      </div>
                    </div>
                  </VersionCard>

                  {/* V2 */}
                  <VersionCard index={1} total={3} label="V2">
                    <div className="grid grid-cols-1 md:grid-cols-[6fr_4fr] gap-5 items-start">
                      ...
                      <div>
                        <p className="text-base text-gray-700 leading-relaxed">We considered a modal or a drawer. We chose tabs — a modal interrupts flow, a drawer adds hierarchy, tabs keep both creation modes equally visible with the lowest switching cost. We also explored a step-by-step wizard but decided against it: ad creation is non-linear, so a single-page layout lets users revise any step at any time.</p>
                      </div>
                    </div>
                  </VersionCard>

                  {/* Final */}
                  <VersionCard index={2} total={3} label="Final Design">
                    <Image src="/opinstantad1.png" alt="Final instant ad design" width={1332} height={1250} unoptimized sizes="(max-width: 1024px) 96vw, 1200px" className="w-full h-auto rounded-xl shadow-lg" />
                  </VersionCard>
                </div>
              </div>
                ...
                <div style={{ isolation: "isolate", position: "relative" }}>
                  ...
                  <VersionCard index={0} total={4} label="V1">
                    <div className="grid grid-cols-1 md:grid-cols-[6fr_4fr] gap-5 items-start">
                      ...
                      <div>
                        <p className="text-base text-gray-700 leading-relaxed mb-3"><span className="font-semibold">Design Goal:</span> Solve the most basic question first — can users see what their competitors are posting?</p>
                        <p className="text-sm font-semibold text-gray-600 mb-2">Features</p>
                        <ul className="list-disc pl-5 space-y-1 text-base text-gray-700"><li>Add competitor accounts</li><li>View competitors&apos; latest posts</li></ul>
                        <p className="text-sm font-semibold text-[#fca5a5] mt-4 mb-2">Limitations</p>
                        <ul className="list-disc pl-5 space-y-1 text-base text-gray-700"><li>Users can only view content</li><li>Trend judgment is fully manual</li></ul>
                      </div>
                    </div>
                  </VersionCard>

                  {/* V2 */}
                  <VersionCard index={1} total={4} label="V2">
                    <div className="grid grid-cols-1 md:grid-cols-[6fr_4fr] gap-5 items-start">
                      ...
                      <div>
                        <p className="text-base text-gray-700 leading-relaxed mb-3"><span className="font-semibold">Added basic analytics.</span> The goal shifted from viewing content to understanding performance data.</p>
                        <p className="text-sm font-semibold text-gray-600 mb-2">Users can</p>
                        <ul className="list-disc pl-5 space-y-1 text-base text-gray-700"><li>Quickly identify top-performing posts</li><li>Find high-engagement content</li></ul>
                        <p className="text-sm font-semibold text-[#fca5a5] mt-4 mb-2">Limitations</p>
                        <ul className="list-disc pl-5 space-y-1 text-base text-gray-700"><li>Manually summarize trends</li><li>Manually analyze changes</li></ul>
                  ...
                  {/* V3 */}
                  <VersionCard index={2} total={4} label="V3">
                    <div className="space-y-4">
                      <p className="text-base text-gray-700 leading-relaxed"><span className="font-semibold">Design Goal:</span> Let the system automatically tell users what&apos;s happening. From V2 to V3, we added an <span className="font-semibold">Anomalies</span> tab. We chose a dedicated tab instead of a filter because filters support passive discovery, while anomalies are proactive signals — users see the most important changes immediately every time they enter the page.</p>
                  ...
                  {/* Final */}
                  <VersionCard index={3} total={4} label="Final Design">
                    <div className="space-y-4">
                      <Image src="/trackingdemo.gif" alt="Tracking final design" width={960} height={553} unoptimized className="w-full max-w-[900px] h-auto rounded-xl border border-gray-200" />
                      <p className="text-base text-gray-700 leading-relaxed">From a business owner perspective, growth comes from learning what competitors are doing right and responding faster. This feature helps businesses track competitor profiles, post performance, and viral content patterns to guide smarter content decisions.</p>
                    </div>
                  </VersionCard>
                </div>
              </div>
                ...
                <div style={{ isolation: "isolate", position: "relative" }}>
                  ...
                  <VersionCard index={0} total={4} label="V1">
                    <div className="space-y-3">
                      ...
                      <p className="text-base text-gray-700 leading-relaxed">Users can see that Impressions increased by xx%, but they do not know why it increased or what to do next. The data is there, but the insight is missing. After viewing this page, users still do not know what they should change.</p>
                  ...
                  <VersionCard index={1} total={4} label="V2">
                    <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-5 items-start">
                      ...
                      <div>
                        <p className="text-base text-gray-700 leading-relaxed mt-1">We added Top Content and Content Type, so users can see which content performs well. But the page still ends there — users must manually switch to Create Post or Create Ad, and the two actions are completely disconnected.</p>
                  ...
                  <VersionCard index={2} total={4} label="V3">
                    <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-5 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-base text-gray-700 leading-relaxed">We placed AI Recommendations at the top of Performance so &ldquo;what to do next&rdquo; is prioritized over &ldquo;what the numbers are.&rdquo;</p>
                      </div>
                    </div>
                  </VersionCard>
                  ...
                  {/* Final */}
                  <VersionCard index={3} total={4} label="Final Design">
                    <Image src="/performance_final_design.gif" alt="Performance final design" width={960} height={553} unoptimized className="w-full max-w-[900px] h-auto rounded-xl border border-gray-200" />
                  </VersionCard>
                </div>
              </div>
          ...
          <div className="text-center">
            <div className="flex justify-center space-x-6 mb-4">
              <a href="https://www.linkedin.com/in/rebecca-huang-a60388249/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">
                <svg className="text-xl w-6 h-6" fill="currentColor" viewBox="0 0 448 512"><path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/></svg>
              </a>
